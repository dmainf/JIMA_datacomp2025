...
raw_metrics = ['MAE', 'RMSE', 'wQL_0.1', 'wQL_0.9', 'DTW_Shape', 'DTW_Time', 'Protrusion_Area']
...
label_map = {
    ...
    'wQL_0.1': r'$QL_{0.1}$',
    'wQL_0.9': r'$QL_{0.9}$',
    'DTW_Shape': r'DTW$_\mathrm{Shape}$',
    'DTW_Time': r'DTW$_\mathrm{Time}$',
    'Protrusion_Area': r'Protrusion Area',
}
...
metric_direction = {
    ...
    'DTW_Shape': 'lower',
    'DTW_Time': 'lower',
    'Protrusion_Area': 'lower',
}

ANOMALY_THRESHOLD = 1e6
metrics_cols = ['MAE', 'RMSE', 'wQL_0.1', 'wQL_0.5', 'wQL_0.9', 'wQL_Mean', 'DTW_Shape', 'DTW_Time', 'Protrusion_Area']
...
def calculate_global_metrics(df):
    ...
    for metric in ['MAE', 'RMSE', 'DTW_Shape', 'DTW_Time', 'Protrusion_Area']:
        if metric in df.columns:
