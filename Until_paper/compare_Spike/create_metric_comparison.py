...
raw_metrics = ['MAE_spike', 'MAE_non_spike', 'RMSE_spike', 'RMSE_non_spike']

label_map = {
    'MAE_spike': r'MAE (Spike)',
    'MAE_non_spike': r'MAE (Non-Spike)',
    'RMSE_spike': r'RMSE (Spike)',
    'RMSE_non_spike': r'RMSE (Non-Spike)',
}
...
metric_direction = {
    ...
    'MAE_non_spike': 'lower',
    'RMSE_spike': 'lower',
    'RMSE_non_spike': 'lower',
}

ANOMALY_THRESHOLD = 1e6
metrics_cols = ['MAE_spike', 'MAE_non_spike', 'RMSE_spike', 'RMSE_non_spike']
