...
raw_metrics = ['MAE', 'RMSE', 'wQL_0.1', 'wQL_0.9', 'DTW_Shape', 'DTW_Time']
...
metrics_cols = ['MAE', 'RMSE', 'wQL_0.1', 'wQL_0.5', 'wQL_0.9', 'wQL_Mean', 'DTW_Shape', 'DTW_Time']
...
def calculate_global_metrics(df):
    ...
    for metric in ['MAE', 'RMSE', 'DTW_Shape', 'DTW_Time']:
        if metric in df.columns:
