...
def fit_predict_sarima(book_name, series, prediction_length, context_length, m):
...
def run_sarima(df, decile_books, all_predict):
    ...
    results = Parallel(n_jobs=CONFIG["n_jobs"])(
        delayed(fit_predict_sarima)(name, series, prediction_length, context_length, CONFIG["seasonal_period"])
